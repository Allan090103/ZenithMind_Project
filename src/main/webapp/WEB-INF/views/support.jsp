...
<div class="app-shell">
    <%@ include file="common/sidebar.jsp" %>
        ...
        .crisis-call { background: #dc2626; }

        .crisis-text { background: #334155; }
...
<div class="app-shell">
    ...
    <main class="content">
        <div class="top-bar">
            <div>
                <p style="margin:0;font-size:14px;color:#7c8b9e;">Chat with our AI assistant, book counselling sessions, and manage appointments</p>
            ...
            <div class="layout">
                <div class="card chat-card">
                    <header>
                        <div style="display:flex;align-items:center;gap:12px;">
                            <div style="width:46px;height:46px;border-radius:15px;background:#00c2c7;color:#fff;display:flex;align-items:center;justify-content:center;font-weight:700;">AI</div>
                            <div>
                                <strong>Mental Health Assistant</strong>
                                <p style="margin:2px 0 0;font-size:13px;color:#6c7b91;">Available 24/7 for guidance</p>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="quick-actions">
                        <button data-quick="I’m feeling anxious. Can you help me calm down?">Feeling anxious</button>
                        <button data-quick="I’m feeling stressed. What coping strategies do you suggest?">Feeling stressed</button>
                        <button data-quick="I need coping strategies for tough days.">Need coping strategies</button>
                    ...
                    <div style="margin-top:22px;">
                        ...
                        <p style="margin:0;">AI Assistant — 24/7<br>Counselors — Mon-Fri, 9AM-5PM<br>Emergency — 24/7 Call 988</p>
                    </div>
                </div>
            </div>
        </section>
