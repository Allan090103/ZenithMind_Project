...
<%
    ...
    String storageKey = "mood_logs_" + roleParam;
    String reminderKey = "mood_reminders_" + roleParam;
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 1100px) {
            ...
            .search { flex-direction: column; align-items: flex-start; width: 100%; }
...
<div class="app-shell">
    ...
    <main class="content">
        <div class="top-bar">
            <div>
                <p style="margin:0;font-size:14px;color:#7c8b9e;">Track your daily emotions and spot patterns in your wellbeing</p>
        ...
        <div class="reminder-card">
            <div>
                ...
                <p style="margin:6px 0 0;color:#5c6f82;">AI-powered suggestions based on your mood and activity patterns</p>
        ...
        <div class="cards-grid">
            <section class="card" id="moodFormCard">
                ...
                <p style="margin-bottom:12px;color:#6c7b91;">Select your current mood and tell us what influenced it.</p>
                ...
                <textarea id="moodNote" rows="3" placeholder="How's your day going? Any thoughts you'd like to share..."></textarea>
