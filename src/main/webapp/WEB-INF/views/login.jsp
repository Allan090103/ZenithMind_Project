    ...
    <section class="card">
        <div class="logo-wrap">
            <svg class="brand-mark" viewBox="0 0 120 120" role="img" aria-labelledby="logoTitle">
                ...
                <path d="M60 12 A27 27 0 0 0 33 37 A23 23 0 0 0 10 60 A23 23 0 0 0 33 83 A24 24 0 0 0 57 107 A24 24 0 0 0 82 92 A22 22 0 0 0 107 70 A18 18 0 0 0 94 45 A27 27 0 0 0 60 12 Z" fill="url(#brainFill)" stroke="#0f7596" stroke-width="4" stroke-linejoin="round"/>
                <path d="M38 73 L53 52 65 70 76 55 94 83" fill="none" stroke="url(#accentStroke)" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        <h1>ZenithMind</h1>
